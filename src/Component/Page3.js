...
const ReferralDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const customerRes = await axios.get(" https://newbackend-jvbs.onrender.com/refer/data");
        ...
        const campaignRes = await axios.get(" https://newbackend-jvbs.onrender.com/campaign/data");
